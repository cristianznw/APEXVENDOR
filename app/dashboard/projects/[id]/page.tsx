 ...
 * Muestra la información completa del proyecto (cliente, descripción, fechas, stack)
 * y permite la gestión de proveedores asignados mediante la VendorsTable.
 * Solo accesible para usuarios con rol 'Admin'.
 *
 * @param props - Contiene los parámetros de la URL, incluyendo el ID del proyecto.
 * @returns El elemento JSX de la vista detallada del proyecto.
 */
export default async function ProjectDetailPage({
  ...
  const providersForAssign = await projectService.listProvidersForAssign(
    project.id_proyecto,
  );
