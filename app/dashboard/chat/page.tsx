...
export default async function ChatPage() {
  ...
  return (
    ...
    <div className="h-[calc(100vh-64px)] w-full flex flex-col overflow-hidden bg-[#fafae6]">
      ...
      <div className="relative z-10 px-4 md:px-8 pt-4 md:pt-6 pb-2 flex justify-between items-center shrink-0">
        <div>
          <h2 className="text-[#252525] font-black text-2xl md:text-3xl uppercase tracking-tighter m-0 leading-none">
            Apex <span className="text-[#bba955]">Vendor</span>
          </h2>
          <p className="text-gray-400 text-[10px] mt-1 uppercase tracking-widest font-bold hidden md:block">
